...
# line 1 "never_ending_simple_state_machine.rl"

# line 5 "never_ending_simple_state_machine.rl"


  
# line 9 "never_ending_simple_state_machine.rb"
class << self
...
# line 8 "never_ending_simple_state_machine.rl"
...
# line 100 "never_ending_simple_state_machine.rb"
begin
	p ||= 0
	pe ||= data.length
	cs = hello_start
...
# line 14 "never_ending_simple_state_machine.rl"
  
# line 109 "never_ending_simple_state_machine.rb"
begin
...
when 0 then
# line 4 "never_ending_simple_state_machine.rl"
		begin
 puts "hello world!" 		end
# line 193 "never_ending_simple_state_machine.rb"
			end # action switch
		end
	end
	if _trigger_goto
...
# line 15 "never_ending_simple_state_machine.rl"
