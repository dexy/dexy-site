...
Dexy puts the finished documents into the output-long/ directory where they are named with the base filename, any filters they have been passed through separated with hyphens, and finally the correct final file extension. So, you should now be able to type:
